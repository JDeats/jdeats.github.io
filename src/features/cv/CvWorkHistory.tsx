    ...
    <>
      ...
      <div style={{marginLeft: "1em"}}>
        ...
        <div
          style={{ fontStyle: "italic", fontSize: "18px", textAlign: "left" }}
        >
          Virgin Orbit - Long Beach, CA
        </div>
        <div className="spread-content">
          <span className="resume-job-title">
            Propulsion Components Test Technician
          </span>
          <span>Nov 2021 - May 2022</span>
        </div>
        <ul>
          <li>
            Setup and validated a wide variety of air and fluid systems to test
            rocket propulsion components such as regulators, check/relief
            valves, flow meters/sensors, RTDs, pressure transducers, etc.
          </li>
          <li>
            Maintained a high level of safety as components were tested up to
            10,000 psi.
          </li>
          <li>
            Performed environmental tests such as thermal cycling, vibration and
            cryogenics testing.
          </li>
          <li>
            Monitored the unit's temperature using National Instruments Flex
            Logger via thermocouples.
          </li>
        </ul>
        ...
        <ul >
          ...
          <li>
            Supported the test lab to ensure anomalies were handled in an
            appropriate and timely manner.
          </li>
          <li>
            Performed Sand and Dust, Salt Fog and Electromagnetic Interference
            tests at an offsite test lab.
          </li>
        </ul>
        ...
        <ul style={{ marginBottom: "5px" }}>
          <li>
            Led a team of 12 test technicians to successfully qualify hybrid
            thermal/night vision goggles for the U.S. Army's ENVGIII program,
            maintaining 24/7 coverage across three shifts.
          </li>
          <li>
            Trained technicians on environmental tests such as thermal cycling,
            vibration, immersion, etc.
          </li>
          <li>
            Maintained test equipment, tracked calibration dates and ensured
            test stations were operational.
          </li>
          <li>
            Troubleshot failures while recording a detailed log of issues
